  ...
  return (
    <div className="min-h-[100dvh] grid grid-cols-1 md:grid-cols-2 bg-[#050510] relative text-white w-full overflow-x-hidden">
      ...
      <div className="flex flex-col justify-center px-8 sm:px-16 lg:px-24 relative z-10 md:border-r border-white/5 py-12 md:py-20 h-full">
        ...
        <h1 className="text-3xl sm:text-4xl font-semibold mb-3 tracking-tight">Welcome back</h1>
        <p className="text-muted-foreground text-sm mb-10 text-balance">Sign in to continue building your professional resumes.</p>
        ...
        <div className="w-full max-w-[420px] bg-[#0A0C16] border border-[#1A1C30] rounded-2xl p-8 shadow-2xl relative">
          ...
          <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="flex items-center justify-between pt-1">
               ...
               <Link href="/forgot-password" className="text-sm text-[#3B82F6] hover:text-[#3B82F6]/80 transition-colors font-medium">
                  Forgot password?
               </Link>
            </div>

            <button className="w-full bg-[#3B82F6] hover:bg-[#3B82F6]/90 text-white font-medium py-3.5 rounded-xl transition-all shadow-[0_0_15px_rgba(59,130,246,0.2)]">
               Sign In
            </button>

            <div className="text-center text-sm text-slate-400 pt-3">
               Don't have an account? <Link href="/signup" className="text-primary hover:text-primary/80 font-medium transition-colors">Sign up</Link>
            </div>
          </form>
        </div>
